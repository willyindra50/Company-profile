...
export default function About() {
  return (
    <section className='relative w-full bg-black text-white py-[80px]'>
      {/* Container max 1440px */}
      <div className='w-full max-w-[1440px] mx-auto px-5 sm:px-8'>
        {/* Top Content */}
        ...
        <div className='flex flex-col md:flex-row gap-10 md:gap-[60px] mt-10 md:mt-[60px]'>
          ...
          {/* Right Features */}
          <div className='grid grid-cols-1 md:grid-cols-2 gap-y-8 sm:gap-y-10 gap-x-8 md:gap-x-[80px] w-full'>
            {/* Item 1 */}
